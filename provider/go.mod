...
replace github.com/devopsarr/terraform-provider-sonarr/shim => ./shim
...
require (
	...
	github.com/devopsarr/terraform-provider-sonarr v0.0.0-20230531083856-b818eafffd1d // indirect
