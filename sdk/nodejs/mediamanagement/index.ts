...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "sonarr:MediaManagement/mediaManagement:MediaManagement":
                return new MediaManagement(name, <any>undefined, { urn })
            case "sonarr:MediaManagement/naming:Naming":
                return new Naming(name, <any>undefined, { urn })
            case "sonarr:MediaManagement/rootFolder:RootFolder":
...
pulumi.runtime.registerResourceModule("sonarr", "MediaManagement/mediaManagement", _module)
pulumi.runtime.registerResourceModule("sonarr", "MediaManagement/naming", _module)
pulumi.runtime.registerResourceModule("sonarr", "MediaManagement/rootFolder", _module)
