 ...
 *
 * const example = new sonarr.indexers.IndexerFanzub("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Indexers/indexerFanzub:IndexerFanzub example 1
 * ```
 */
export class IndexerFanzub extends pulumi.CustomResource {
    /**
     * Get an existing IndexerFanzub resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IndexerFanzubState, opts?: pulumi.CustomResourceOptions): IndexerFanzub {
        return new IndexerFanzub(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sonarr:Indexers/indexerFanzub:IndexerFanzub';

    /**
     * Returns true if the given object is an instance of IndexerFanzub.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IndexerFanzub {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IndexerFanzub.__pulumiType;
    }
    ...
    /**
     * Create a IndexerFanzub resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IndexerFanzubArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IndexerFanzubArgs | IndexerFanzubState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IndexerFanzubState | undefined;
            ...
            const args = argsOrState as IndexerFanzubArgs | undefined;
        ...
        super(IndexerFanzub.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering IndexerFanzub resources.
 */
export interface IndexerFanzubState {
    /**
     * Search anime in standard format.
     */
...
/**
 * The set of arguments for constructing a IndexerFanzub resource.
 */
export interface IndexerFanzubArgs {
    /**
     * Search anime in standard format.
     */
    animeStandardFormatSearch?: pulumi.Input<boolean>;
