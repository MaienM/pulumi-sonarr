 ...
 *
 * const example = new sonarr.indexers.IndexerBroadcasthenet("example", {
 *     apiKey: "APIKey",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Indexers/indexerBroadcasthenet:IndexerBroadcasthenet example 1
 * ```
 */
export class IndexerBroadcasthenet extends pulumi.CustomResource {
    /**
     * Get an existing IndexerBroadcasthenet resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IndexerBroadcasthenetState, opts?: pulumi.CustomResourceOptions): IndexerBroadcasthenet {
        return new IndexerBroadcasthenet(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sonarr:Indexers/indexerBroadcasthenet:IndexerBroadcasthenet';

    /**
     * Returns true if the given object is an instance of IndexerBroadcasthenet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IndexerBroadcasthenet {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IndexerBroadcasthenet.__pulumiType;
    }
    ...
    /**
     * Create a IndexerBroadcasthenet resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IndexerBroadcasthenetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IndexerBroadcasthenetArgs | IndexerBroadcasthenetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IndexerBroadcasthenetState | undefined;
            ...
            const args = argsOrState as IndexerBroadcasthenetArgs | undefined;
        ...
        super(IndexerBroadcasthenet.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering IndexerBroadcasthenet resources.
 */
export interface IndexerBroadcasthenetState {
    /**
     * API key.
     */
...
/**
 * The set of arguments for constructing a IndexerBroadcasthenet resource.
 */
export interface IndexerBroadcasthenetArgs {
    /**
     * API key.
     */
    apiKey: pulumi.Input<string>;
