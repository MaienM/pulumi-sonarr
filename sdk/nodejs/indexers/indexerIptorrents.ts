 ...
 *
 * const example = new sonarr.indexers.IndexerIptorrents("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Indexers/indexerIptorrents:IndexerIptorrents example 1
 * ```
 */
export class IndexerIptorrents extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Indexers/indexerIptorrents:IndexerIptorrents';
