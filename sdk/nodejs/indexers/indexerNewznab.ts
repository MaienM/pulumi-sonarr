 ...
 *
 * const example = new sonarr.indexers.IndexerNewznab("example", {
 *     apiPath: "/api",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Indexers/indexerNewznab:IndexerNewznab example 1
 * ```
 */
export class IndexerNewznab extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Indexers/indexerNewznab:IndexerNewznab';
