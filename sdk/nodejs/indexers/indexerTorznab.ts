 ...
 *
 * const example = new sonarr.indexers.IndexerTorznab("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Indexers/indexerTorznab:IndexerTorznab example 1
 * ```
 */
export class IndexerTorznab extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Indexers/indexerTorznab:IndexerTorznab';
