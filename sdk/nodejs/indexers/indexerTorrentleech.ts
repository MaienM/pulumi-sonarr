 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Indexers/indexerTorrentleech:IndexerTorrentleech example 1
 * ```
 */
export class IndexerTorrentleech extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Indexers/indexerTorrentleech:IndexerTorrentleech';
