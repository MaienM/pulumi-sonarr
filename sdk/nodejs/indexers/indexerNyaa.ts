 ...
 *
 * const example = new sonarr.indexers.IndexerNyaa("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Indexers/indexerNyaa:IndexerNyaa example 1
 * ```
 */
export class IndexerNyaa extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Indexers/indexerNyaa:IndexerNyaa';
