 ...
 *
 * const example = new sonarr.indexers.IndexerTorrentRss("example", {
 *     allowZeroSize: true,
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Indexers/indexerTorrentRss:IndexerTorrentRss example 1
 * ```
 */
export class IndexerTorrentRss extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Indexers/indexerTorrentRss:IndexerTorrentRss';
