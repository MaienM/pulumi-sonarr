 ...
 *
 * const example = new sonarr.indexers.IndexerFilelist("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Indexers/indexerFilelist:IndexerFilelist example 1
 * ```
 */
export class IndexerFilelist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Indexers/indexerFilelist:IndexerFilelist';
