 ...
 *
 * const example = new sonarr.importlists.ImportListCustom("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:ImportLists/importListCustom:ImportListCustom example 1
 * ```
 */
export class ImportListCustom extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:ImportLists/importListCustom:ImportListCustom';
