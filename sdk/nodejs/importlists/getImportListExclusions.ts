 ...
 *
 * const example = sonarr.ImportLists.getImportListExclusions({});
 * ```
 */
export function getImportListExclusions(opts?: pulumi.InvokeOptions): Promise<GetImportListExclusionsResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("sonarr:ImportLists/getImportListExclusions:getImportListExclusions", {
    }, opts);
}
