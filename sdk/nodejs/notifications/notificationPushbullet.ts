 ...
 *
 * const example = new sonarr.notifications.NotificationPushbullet("example", {
 *     apiKey: "Token",
 *     deviceIds: ["test"],
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationPushbullet:NotificationPushbullet example 1
 * ```
 */
export class NotificationPushbullet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationPushbullet:NotificationPushbullet';
