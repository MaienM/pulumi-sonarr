 ...
 *
 * const example = new sonarr.notifications.NotificationEmail("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationEmail:NotificationEmail example 1
 * ```
 */
export class NotificationEmail extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationEmail:NotificationEmail';
