 ...
 *
 * const example = new sonarr.notifications.Notification("example", {
...
export class Notification extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notification:Notification';
    ...
    constructor(name: string, argsOrState?: NotificationArgs | NotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        const secretOpts = { additionalSecretOutputs: ["accessTokenSecret", "apiKey", "appToken", "authPassword", "authToken", "configurationKey", "consumerSecret", "key", "password", "token"] };
