 ...
 *
 * const example = new sonarr.notifications.NotificationProwl("example", {
 *     apiKey: "APIKey",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationProwl:NotificationProwl example 1
 * ```
 */
export class NotificationProwl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationProwl:NotificationProwl';
