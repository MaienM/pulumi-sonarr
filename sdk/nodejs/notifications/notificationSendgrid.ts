 ...
 *
 * const example = new sonarr.notifications.NotificationSendgrid("example", {
 *     apiKey: "APIkey",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationSendgrid:NotificationSendgrid example 1
 * ```
 */
export class NotificationSendgrid extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationSendgrid:NotificationSendgrid';
