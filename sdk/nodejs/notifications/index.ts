...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "sonarr:Notifications/notification:Notification":
                return new Notification(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationApprise:NotificationApprise":
                return new NotificationApprise(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationBoxcar:NotificationBoxcar":
                return new NotificationBoxcar(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationCustomScript:NotificationCustomScript":
                return new NotificationCustomScript(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationDiscord:NotificationDiscord":
                return new NotificationDiscord(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationEmail:NotificationEmail":
                return new NotificationEmail(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationEmby:NotificationEmby":
                return new NotificationEmby(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationGotify:NotificationGotify":
                return new NotificationGotify(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationJoin:NotificationJoin":
                return new NotificationJoin(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationKodi:NotificationKodi":
                return new NotificationKodi(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationMailgun:NotificationMailgun":
                return new NotificationMailgun(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationNtfy:NotificationNtfy":
                return new NotificationNtfy(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationPlex:NotificationPlex":
                return new NotificationPlex(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationProwl:NotificationProwl":
                return new NotificationProwl(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationPushbullet:NotificationPushbullet":
                return new NotificationPushbullet(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationPushover:NotificationPushover":
                return new NotificationPushover(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationSendgrid:NotificationSendgrid":
                return new NotificationSendgrid(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationSignal:NotificationSignal":
                return new NotificationSignal(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationSimplepush:NotificationSimplepush":
                return new NotificationSimplepush(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationSlack:NotificationSlack":
                return new NotificationSlack(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationSynologyIndexer:NotificationSynologyIndexer":
                return new NotificationSynologyIndexer(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationTelegram:NotificationTelegram":
                return new NotificationTelegram(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationTrakt:NotificationTrakt":
                return new NotificationTrakt(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationTwitter:NotificationTwitter":
                return new NotificationTwitter(name, <any>undefined, { urn })
            case "sonarr:Notifications/notificationWebhook:NotificationWebhook":
...
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notification", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationApprise", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationBoxcar", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationCustomScript", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationDiscord", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationEmail", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationEmby", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationGotify", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationJoin", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationKodi", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationMailgun", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationNtfy", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationPlex", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationProwl", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationPushbullet", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationPushover", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationSendgrid", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationSignal", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationSimplepush", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationSlack", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationSynologyIndexer", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationTelegram", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationTrakt", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationTwitter", _module)
pulumi.runtime.registerResourceModule("sonarr", "Notifications/notificationWebhook", _module)
