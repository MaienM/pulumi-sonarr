 ...
 *
 * const example = new sonarr.notifications.NotificationJoin("example", {
 *     apiKey: "Key",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationPushover:NotificationPushover example 1
 * ```
 */
export class NotificationPushover extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationPushover:NotificationPushover';
