 ...
 *
 * const example = new sonarr.notifications.NotificationSlack("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationSlack:NotificationSlack example 1
 * ```
 */
export class NotificationSlack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationSlack:NotificationSlack';
