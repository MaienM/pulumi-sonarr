 ...
 *
 * const example = new sonarr.notifications.NotificationPlex("example", {
 *     authToken: "AuthTOKEN",
 *     host: "plex.lcl",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationPlex:NotificationPlex example 1
 * ```
 */
export class NotificationPlex extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationPlex:NotificationPlex';
