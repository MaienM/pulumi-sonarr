 ...
 *
 * const example = new sonarr.notifications.NotificationMailgun("example", {
 *     apiKey: "APIkey",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationMailgun:NotificationMailgun example 1
 * ```
 */
export class NotificationMailgun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationMailgun:NotificationMailgun';
