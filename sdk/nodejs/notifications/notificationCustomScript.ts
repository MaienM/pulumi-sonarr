 ...
 *
 * const example = new sonarr.notifications.NotificationCustomScript("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationCustomScript:NotificationCustomScript example 1
 * ```
 */
export class NotificationCustomScript extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationCustomScript:NotificationCustomScript';
