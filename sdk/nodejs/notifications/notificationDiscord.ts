 ...
 *
 * const example = new sonarr.notifications.NotificationDiscord("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationDiscord:NotificationDiscord example 1
 * ```
 */
export class NotificationDiscord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationDiscord:NotificationDiscord';
