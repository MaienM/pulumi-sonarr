 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationJoin:NotificationJoin example 1
 * ```
 */
export class NotificationJoin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationJoin:NotificationJoin';
