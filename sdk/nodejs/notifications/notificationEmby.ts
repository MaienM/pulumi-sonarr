 ...
 *
 * const example = new sonarr.notifications.NotificationEmby("example", {
 *     apiKey: "API_Key",
 *     host: "emby.lcl",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationEmby:NotificationEmby example 1
 * ```
 */
export class NotificationEmby extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationEmby:NotificationEmby';
