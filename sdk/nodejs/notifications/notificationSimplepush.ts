 ...
 *
 * const example = new sonarr.notifications.NotificationSimplepush("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:Notifications/notificationSimplepush:NotificationSimplepush example 1
 * ```
 */
export class NotificationSimplepush extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Notifications/notificationSimplepush:NotificationSimplepush';
