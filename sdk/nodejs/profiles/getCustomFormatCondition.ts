 ...
 *
 * const exampleCustomFormatCondition = sonarr.Profiles.getCustomFormatCondition({
 *     name: "Example",
...
export function getCustomFormatCondition(args: GetCustomFormatConditionArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomFormatConditionResult> {
    ...
    return pulumi.runtime.invoke("sonarr:Profiles/getCustomFormatCondition:getCustomFormatCondition", {
