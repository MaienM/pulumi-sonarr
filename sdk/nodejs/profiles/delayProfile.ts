 ...
 *
 * const example = new sonarr.profiles.DelayProfile("example", {
...
export class DelayProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:Profiles/delayProfile:DelayProfile';
     ...
     */
    public readonly bypassIfAboveCustomFormatScore!: pulumi.Output<boolean>;
    /**
     ...
     */
    public readonly minimumCustomFormatScore!: pulumi.Output<number>;
    /**
     * Order.
     */
    ...
    constructor(name: string, argsOrState?: DelayProfileArgs | DelayProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["bypassIfAboveCustomFormatScore"] = state ? state.bypassIfAboveCustomFormatScore : undefined;
            ...
            resourceInputs["minimumCustomFormatScore"] = state ? state.minimumCustomFormatScore : undefined;
            ...
            resourceInputs["bypassIfAboveCustomFormatScore"] = args ? args.bypassIfAboveCustomFormatScore : undefined;
            ...
            resourceInputs["minimumCustomFormatScore"] = args ? args.minimumCustomFormatScore : undefined;
...
export interface DelayProfileState {
     ...
     * Bypass for higher custom format score flag.
     */
    bypassIfAboveCustomFormatScore?: pulumi.Input<boolean>;
    /**
     * Bypass for highest quality flag.
     */
     ...
     * Minimum custom format score.
     */
    minimumCustomFormatScore?: pulumi.Input<number>;
    /**
     * Order.
     */
