 ...
 *
 * const example = new sonarr.downloadclients.DownloadClientUsenetBlackhole("example", {
 *     enable: true,
 *     name: "Example",
 *     nzbFolder: "/nzb/",
 *     priority: 1,
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:DownloadClients/downloadClientUsenetBlackhole:DownloadClientUsenetBlackhole example 1
 * ```
 */
export class DownloadClientUsenetBlackhole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/downloadClientUsenetBlackhole:DownloadClientUsenetBlackhole';
