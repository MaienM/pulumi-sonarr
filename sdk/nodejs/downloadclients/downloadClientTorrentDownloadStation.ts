 ...
 *
 * const example = new sonarr.downloadclients.DownloadClientTorrentDownloadStation("example", {
 *     enable: true,
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:DownloadClients/downloadClientTorrentDownloadStation:DownloadClientTorrentDownloadStation example 1
 * ```
 */
export class DownloadClientTorrentDownloadStation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/downloadClientTorrentDownloadStation:DownloadClientTorrentDownloadStation';
