 ...
 *
 * const example = new sonarr.downloadclients.DownloadClientPneumatic("example", {
 *     enable: true,
 *     name: "Example",
 *     nzbFolder: "/nzb/",
 *     priority: 1,
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:DownloadClients/downloadClientPneumatic:DownloadClientPneumatic example 1
 * ```
 */
export class DownloadClientPneumatic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/downloadClientPneumatic:DownloadClientPneumatic';
