 ...
 *
 * const example = new sonarr.downloadclients.RemotePathMapping("example", {
...
export class RemotePathMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/remotePathMapping:RemotePathMapping';
