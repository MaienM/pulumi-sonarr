 ...
 *
 * const example = new sonarr.downloadclients.DownloadClientUsenetDownloadStation("example", {
 *     enable: true,
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:DownloadClients/downloadClientUsenetDownloadStation:DownloadClientUsenetDownloadStation example 1
 * ```
 */
export class DownloadClientUsenetDownloadStation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/downloadClientUsenetDownloadStation:DownloadClientUsenetDownloadStation';
