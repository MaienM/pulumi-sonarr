 ...
 *
 * const example = new sonarr.downloadclients.DownloadClientFlood("example", {
 *     additionalTags: [
 *         0,
 *         1,
 *     ],
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:DownloadClients/downloadClientFlood:DownloadClientFlood example 1
 * ```
 */
export class DownloadClientFlood extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/downloadClientFlood:DownloadClientFlood';
