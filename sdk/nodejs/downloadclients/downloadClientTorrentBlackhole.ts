 ...
 *
 * const example = new sonarr.downloadclients.DownloadClientTorrentBlackhole("example", {
 *     enable: true,
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:DownloadClients/downloadClientTorrentBlackhole:DownloadClientTorrentBlackhole example 1
 * ```
 */
export class DownloadClientTorrentBlackhole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/downloadClientTorrentBlackhole:DownloadClientTorrentBlackhole';
