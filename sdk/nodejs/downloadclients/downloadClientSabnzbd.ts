 ...
 *
 * const example = new sonarr.downloadclients.DownloadClientSabnzbd("example", {
 *     apiKey: "test",
 *     enable: true,
 *     host: "sabnzbd",
 *     name: "Example",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:DownloadClients/downloadClientSabnzbd:DownloadClientSabnzbd example 1
 * ```
 */
export class DownloadClientSabnzbd extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/downloadClientSabnzbd:DownloadClientSabnzbd';
