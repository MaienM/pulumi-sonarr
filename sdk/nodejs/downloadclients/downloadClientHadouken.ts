 ...
 *
 * const example = new sonarr.downloadclients.DownloadClientHadouken("example", {
 *     enable: true,
 *     host: "hadouken",
 *     name: "Example",
 *     password: "password",
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:DownloadClients/downloadClientHadouken:DownloadClientHadouken example 1
 * ```
 */
export class DownloadClientHadouken extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/downloadClientHadouken:DownloadClientHadouken';
