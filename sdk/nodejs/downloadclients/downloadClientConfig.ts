 ...
 *
 * const example = new sonarr.downloadclients.DownloadClientConfig("example", {
 ...
 *
 * ```sh
 *  $ pulumi import sonarr:DownloadClients/downloadClientConfig:DownloadClientConfig example
 * ```
 */
export class DownloadClientConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sonarr:DownloadClients/downloadClientConfig:DownloadClientConfig';
