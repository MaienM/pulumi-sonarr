...
SHELL            := /bin/bash
PROJECT          := github.com/MaienM/pulumi-sonarr
NODE_MODULE_NAME := @maienm/pulumi-sonarr
TF_NAME          := sonarr
...
TFGEN            := pulumi-tfgen-sonarr
PROVIDER         := pulumi-resource-sonarr
...
upstream/.git:
	...
	git -c advice.detachedHead=false clone --depth 1 --branch 'v$(PROVIDER_VERSION)' 'https://github.com/devopsarr/terraform-provider-sonarr' upstream
